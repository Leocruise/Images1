		...
		<section class="ftco-section ftco-no-pt ftco-no-pb bg-light">
	    	<div class="container px-0">
	    		<div class="row no-gutters">
		                <div class="text p-4">
                                    <h3 class="mb-2" style="color:brown;"><a href="single.html"></a><b>Similarity Search for Encrypted Images in Secure Cloud Computing</b></h3><br>
                                    <div id="coin-slider"> <a href="#"><center><img src="images/cloud4.gif"  style="margin-left: 150px; border-radius: 30px;" alt="" /> </center></a></div>
