...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <body>
	...
	<div id="colorlib-page">
		...
		</aside> <!-- END COLORLIB-ASIDE --><div id="colorlib-main">
		<section class="ftco-section ftco-no-pt ftco-no-pb bg-light">
	    	<div class="container px-0">
	    		<div class="row no-gutters">
		                     <div class="text p-4">
		              <h3 class="mb-2" style="color:brown;"><a href="single.html"></a>An Efficient Privacy Preserving  Biometric Identification Scheme in Cloud Computing</h3>
		...
		<style>
                    ...
                    <tr>
                        ...
                        <td style='color:navy; font-weight: bold;'>Trapdoor</td>
                         <td style='color:navy; font-weight: bold;'>Image Name</td>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from Request where status='waiting' ");
                        ...
                        <td style='font-weight: bold; color: darkorange;'><%=rs.getString("status")%></td>
                        <td style='font-weight: bold;'><a href='Key_File.jsp?sno=<%=rs.getString("sno")%>&&name=<%=rs.getString("name")%>&&oname=<%=rs.getString("oname")%>&&reg=<%=rs.getString("reg")%>&&trap=<%=rs.getString("trap")%>&&id=<%=rs.getString("id")%>&&image=<%=rs.getString("image")%>' style='color:Green;'>Send Key</a></td>
