	    	...
	    	<div class="container px-0">
	    		<div class="row no-gutters">
		              ...
		              <h3 class="mb-2" style="color:brown;"><a href="single.html"></a>An Efficient Privacy Preserving  Biometric Identification Scheme in Cloud Computing</h3>
                              <br><br>   <br><center><h2 style="font-family: cursive; color:darkblue;">Graph</h2></center><br>
		<style>
                    table{
                        line-height: 25px;
                        width: 50%;
                ...
                <a href="Graph3.jsp"><h4>Result of Number of the attribute</h4></a>                                     
                <a href="Graph2.jsp"><h4>Result of Count of download</h4></a></div>
                        </div>
                </div>
	    	</div>
	    </section>
