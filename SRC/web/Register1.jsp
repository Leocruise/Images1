  ...
  <body>
	...
	<div id="colorlib-page">
      ...
      tr,td{
        ...
        <h2 style="margin-top: 20px; color:darkblue; margin-left: 150px;font-family: cambria;font-weight: bold; font-size: 30px;">Data User Registration Page</h2><br>
        <form action="Reg_Login_Action" method='post' enctype="multipart/form-data">
        <table>
