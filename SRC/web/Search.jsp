	    	...
	    	<div class="container px-0">
	    		<div class="row no-gutters">
		                <div class="text p-4">
                                    ...
                                    <br><center><h2 style="font-family: cursive; color:darkblue;"><b>Search File Search With K</b></h2></center><br>
			<div>
                       <style>
                    table{
                        line-height: 25px;
                ...
                <table>
                    <tr>
                        ...
                        <td style='font-weight: bold;'><a href='Request_File.jsp?name=<%=name%>&&id=<%=id%>&&reg=<%=rs.getString("reg")%>&&oname=<%=rs.getString("name")%>&&image=<%=rs.getString("image")%>&&trap=<%=rs.getString("trapdoor")%>' style='color:Red;'>Request Send</a></td>
                     </tr><%}%>
                </table>  </div>
                        </div>
                </div>
