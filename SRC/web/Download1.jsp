...
<html lang="en">
  <head>
    <title> An Efficient Privacy Preserving Biometric Identification Scheme in Cloud Computing</title>
    <meta charset="utf-8">
	    	...
	    	<div class="container px-0">
	    		<div class="row no-gutters">
		                <div class="text p-4">
		                 ...
		                 <br><center><h2 style="font-family: cursive;">Enter Your Private File</h2></center><br>
			<div>
                       <style>
                    table{
                        line-height: 25px;
